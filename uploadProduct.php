	...
	<body>
		...
		<!-- One -->
			...
			<div class="row">
				...
				<div class="col-sm-6">
				<div class="select-wrapper" style="width: auto" >
				    <select required style="background-color:white;color: black;">
				       <option value="" style="color:black;">-Weight-</option>
				       <option value="" style="color:black;">perkg</option>
				       <option value="" style="color:black;">perton</option>
				</select>
				</div>
